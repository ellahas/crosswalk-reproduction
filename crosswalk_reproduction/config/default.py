...
_C.DATASET_PATHS = CN()
_C.DATASET_PATHS.DATASETS = ['rice', 'twitter', 'deezer', 'pokec_region', 'pokec_gender', 'tolokers']
_C.DATASET_PATHS.ATTR_PATHS = ['data/immutable/rice/rice_subset.attr', 'data/immutable/twitter/sample_4000.attr',
                               ...
                               'no_separate_attr_file', 'no_separate_attr_file']
...
_C.DATASET_PATHS.LINK_PATHS = ['data/immutable/rice/rice_subset.links', 'data/immutable/twitter/sample_4000.links',
                               ...
                               'data/immutable/pokec/pokec_processed.pt', 'data/immutable/tolokers/tolokers_processed.pt']
_C.GRAPH_KEYS = CN()
...
_C.NODE_CLASSIFICATION.KERNEL = 'rbf'           # default from sklearn
